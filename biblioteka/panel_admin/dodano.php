...
$sql="INSERT INTO ksiazki(id_ksiazki, tytul, autor, ilosc_kopi, id_rodzaj) VALUES ('','$tytul','$autor','$ilosc_kopi','$id_rodzaj');";
...
'biblioteka'
  ...
  /*SELECT * FROM ksiazki INNER JOIN rodzaj ON ksiazki.id_rodzaj=rodzaj.id_rodzaj ORDER BY  id_ksiazki ASC;*/
  }
